...
- Generated at UTC: `2026-07-21T08:27:39+00:00`
- Root: `C:\Users\zycie\CTOAi`
- Coverage: `All files under workspace root, including .git internals.`
- Files inventoried: `48350`
- Non-regular entries skipped: `4229`
- Git tracked files: `1329`
- Dirty status entries: `3`
...
| Category | Files | Size |
| --- | ---: | ---: |
| `git_internal` | 461 | 1022.63 MB |
| `local_secret_or_sensitive` | 8 | 0.08 MB |
| `runtime_or_local_state` | 7733 | 1748.03 MB |
| `tracked_source` | 1323 | 11.37 MB |
| `untracked_local` | 55 | 0.39 MB |
| `untracked_source_candidate` | 7432 | 754.43 MB |
...
| --- | --- | --- |
| `regular_file_inventory` | `passed` | 48350 regular files inventoried. |
| `non_regular_accounting` | `passed` | 4229 non-regular entries skipped ({'directory': 4229}). |
| `bounded_hashing` | `passed` | 16390 files hashed with max size 2000000 bytes. |
| `sensitive_content_omitted` | `passed` | 8 sensitive-name files inventoried; 0 hashed. |
| `git_status_captured` | `passed` | 3 git status entries captured. |
...
- Finding: Worktree is dirty with 3 status entries.
...
- Finding: Runtime/local state is large and active (7733 files).
