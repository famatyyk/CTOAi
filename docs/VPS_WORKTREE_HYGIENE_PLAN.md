...
9. [ ] Monitor first 3 nightly dry-check runs and alert on any non-empty porcelain status. (ACTIVE NEXT STEP; one-command runner: scripts/ops/phase5_nightly_sync.py; morning brief: docs/evidence/vps-worktree-hygiene/phase5-morning-brief.md)
