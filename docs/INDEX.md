...
- [P9 Conditions Shadow Acceptance](otclient/P9_CONDITIONS_SHADOW_ACCEPTANCE.md): strict recomputation, explicit operator confirmation, and a no-action acceptance receipt without starting P10.
