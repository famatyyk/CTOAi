...
class TestAgentDefinitions(unittest.TestCase):
    ...
    def test_agent_count(self):
        ...
        self.assertGreaterEqual(
            len(agents), 10, f"Expected at least 10 agents, got {len(agents)}"
        )
...
class TestBraverTemplates(unittest.TestCase):
    ...
    def test_template_missing_variables_are_explicit_unknowns(self):
        """Verify incomplete prompt context does not crash rendering."""
        from braver_templates import render_template
...
class TestToolAdvisor(unittest.TestCase):
    ...
    def test_tool_scoring(self):
        ...
        score = score_tool(
            "github-api", {"efficacy": 0.4, "safety": 0.3, "cost": 0.2, "latency": 0.1}
        )
