...
- Keep boundaries clear: orchestration in `runner/`, policy contracts in `policies/`, sprint/backlog definitions in `workflows/`, and CI workflow definitions in `.github/workflows/`.
