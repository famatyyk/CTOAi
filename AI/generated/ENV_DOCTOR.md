...
Generated at: `2026-07-15T17:02:58+00:00`
Overall status: `warn`

| Check | Status | Key evidence |
|---|---|---|
| `git` | `ok` | branch=codex/p14-independent-runner; dirty=124; path=C:\Program Files\Git\cmd\git.EXE |
...
| `vscode` | `ok` | openai=['openai.chatgpt@26.707.71524']; old_dirs=1 |
| `github` | `warn` | open_prs=7; dirty_prs=5; failed_runs=1 |
