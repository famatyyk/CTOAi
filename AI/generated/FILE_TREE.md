...
| `scripts/ops/sprint041_validate.py` | 4145 |
| `scripts/ops/sprint042_validate.py` | 7667 |
| `scripts/ops/sprint043_validate.py` | 8227 |
| `scripts/ops/sprint044_validate.py` | 8317 |
| `scripts/ops/sprint045_validate.py` | 7971 |
| `scripts/ops/sprint046_validate.py` | 7971 |
| `scripts/ops/sprint047_validate.py` | 7971 |
| `scripts/ops/sprint048_validate.py` | 8092 |
| `scripts/ops/sprint049_validate.py` | 8094 |
| `scripts/ops/sprint050_validate.py` | 8091 |
| `scripts/ops/sprint051_validate.py` | 8091 |
| `scripts/ops/sprint052_validate.py` | 10108 |
| `scripts/ops/sprint053_validate.py` | 10108 |
| `scripts/ops/sprint054_validate.py` | 10408 |
| `scripts/ops/sprint055_validate.py` | 10408 |
| `scripts/ops/sprint056_validate.py` | 10408 |
| `scripts/ops/sprint057_validate.py` | 10408 |
| `scripts/ops/sprint058_validate.py` | 10614 |
| `scripts/ops/sprint059_validate.py` | 10614 |
| `scripts/ops/sprint060_validate.py` | 10614 |
| `scripts/ops/sprint061_validate.py` | 10614 |
| `scripts/ops/sprint062_validate.py` | 10614 |
| `scripts/ops/sprint063_validate.py` | 10614 |
| `scripts/ops/sprint064_validate.py` | 10614 |
| `scripts/ops/sprint065_validate.py` | 10614 |
| `scripts/ops/sprint066_validate.py` | 7357 |
| `scripts/ops/sprint067_validate.py` | 8432 |
| `scripts/ops/sprint068_validate.py` | 8625 |
| `scripts/ops/sprint069_validate.py` | 8610 |
| `scripts/ops/sprint070_validate.py` | 5962 |
| `scripts/ops/sprint0_validate.ps1` | 1274 |
| `scripts/ops/sprint_state_sync.py` | 6332 |
| `scripts/ops/sprint_validator_engine.py` | 5922 |
| `scripts/ops/status_overlay_smoke.ps1` | 639 |
| `scripts/ops/sync-live-targets.py` | 4098 |
| `scripts/ops/sync-mythibia-client.ps1` | 25244 |
| `scripts/ops/tibia_source_collector.py` | 23670 |
| `scripts/ops/triage_entropy_carves.py` | 7593 |
| `scripts/ops/triage_io_dense_dumps.py` | 2522 |
| `scripts/ops/validate_release_artifact_contract.py` | 1806 |
| `scripts/ops/watch-mythibia-client-sync.ps1` | 4680 |
| `scripts/ops/watchdog-mythibia-alert.ps1` | 1181 |
| `scripts/ops/wave_summary_utf8.py` | 4039 |
| `scripts/ops/windows-task-guard.ps1` | 3631 |
| `scripts/rsa_scan.py` | 857 |
| `scripts/test_local_model.py` | 3221 |
| `scripts/windows/build-ctoa-desktop-exe.ps1` | 1210 |
| `scripts/windows/install-ctoa-vscode-extensions.ps1` | 2055 |
| `scripts/windows/open-control-center.ps1` | 1957 |
| `scripts/windows/solteria_helper_test_env.ps1` | 401578 |
...
| `tests/test_api_chat_safety.py` | 16769 |
...
| `tests/test_control_center_p7_cockpit_smoke.py` | 8406 |
| `tests/test_control_center_p7_evidence_review.py` | 6435 |
| `tests/test_control_center_p7_safe_write_dry_run_smoke.py` | 7433 |
| `tests/test_copilot_instructions.py` | 1049 |
| `tests/test_ctoa_full_workspace_audit.py` | 7633 |
...
| `tests/test_link_check_docs.py` | 1239 |
| `tests/test_llm_provider_url_security.py` | 3168 |
| `tests/test_mobile_console_api_contract_snapshot.py` | 2874 |
| `tests/test_mobile_console_capability_gate.py` | 2496 |
...
| `tests/test_otclient_helper_zerobot_shell.py` | 183125 |
...
| `tests/test_powershell_launcher_security.py` | 6507 |
...
| `tests/test_repo_cleanup_waves_contract.py` | 1092 |
| `tests/test_repo_hygiene_audit.py` | 3412 |
| `tests/test_repo_hygiene_distribution.py` | 1161 |
...
| `tests/test_security_hardening.py` | 15137 |
| `tests/test_solteria_api_audit.py` | 2554 |
| `tests/test_solteria_helper_goal_audit.py` | 8806 |
| `tests/test_solteria_helper_release_gate.py` | 21888 |
...
| `tests/test_sprint039_validate.py` | 1543 |
| `tests/test_sprint040_validate.py` | 1543 |
...
| `tests/test_sprint070_validate.py` | 4303 |
| `tests/test_sprint_state_sync.py` | 6025 |
...
| `tests/test_tasks_json_hygiene.py` | 932 |
...
| `tests/test_validate_release_artifact_contract.py` | 1852 |
...
| `tests/unit/bot/test_spell_rotation.py` | 4858 |
...
| `tools/vscode-extensions/otcdochub/CHANGELOG.md` | 236 |
| `tools/vscode-extensions/otcdochub/out/extension.js` | 4979 |
| `tools/vscode-extensions/otcdochub/out/test/runTest.js` | 861 |
| `tools/vscode-extensions/otcdochub/out/test/suite/extension.test.js` | 596 |
| `tools/vscode-extensions/otcdochub/out/test/suite/index.js` | 1277 |
| `tools/vscode-extensions/otcdochub/package.json` | 1279 |
| `tools/vscode-extensions/otcdochub/README.md` | 1366 |
| `tools/vscode-extensions/otcdochub/web/script.js` | 1776 |
| `tools/vscode-extensions/otui-highlights/.vscode/launch.json` | 663 |
| `tools/vscode-extensions/otui-highlights/CHANGELOG.md` | 479 |
| `tools/vscode-extensions/otui-highlights/constants/otmodCommonProperties.ts` | 1467 |
| `tools/vscode-extensions/otui-highlights/constants/otuiAnchorPropertyValues.ts` | 3614 |
| `tools/vscode-extensions/otui-highlights/constants/otuiCommonProperties.ts` | 12998 |
| `tools/vscode-extensions/otui-highlights/constants/otuiFunctionTriggerProperties.ts` | 158 |
| `tools/vscode-extensions/otui-highlights/extension.ts` | 10453 |
| `tools/vscode-extensions/otui-highlights/language-configuration.json` | 852 |
| `tools/vscode-extensions/otui-highlights/LICENSE.MD` | 1091 |
| `tools/vscode-extensions/otui-highlights/out/constants/otmodCommonProperties.js` | 1602 |
| `tools/vscode-extensions/otui-highlights/out/constants/otuiAnchorPropertyValues.js` | 3964 |
| `tools/vscode-extensions/otui-highlights/out/constants/otuiCommonProperties.js` | 14737 |
| `tools/vscode-extensions/otui-highlights/out/constants/otuiFunctionTriggerProperties.js` | 295 |
| `tools/vscode-extensions/otui-highlights/out/extension.js` | 11302 |
| `tools/vscode-extensions/otui-highlights/package-lock.json` | 1424 |
| `tools/vscode-extensions/otui-highlights/package.json` | 2019 |
| `tools/vscode-extensions/otui-highlights/README.md` | 549 |
| `tools/vscode-extensions/otui-highlights/snippets/otui-snippets.json` | 210 |
| `tools/vscode-extensions/otui-highlights/syntaxes/otmod.tmLanguage.json` | 2872 |
| `tools/vscode-extensions/otui-highlights/syntaxes/otui.tmLanguage.json` | 2853 |
| `tools/vscode-extensions/otui-highlights/themes.yml` | 54594 |
| `tools/vscode-extensions/otui-highlights/tsconfig.json` | 238 |
| `tools/vscode-extensions/otui-highlights/vsc-extension-quickstart.md` | 1616 |
| `tools/vscode-extensions/README.md` | 721 |
...
| `web/src/app/api/control-center/legacy/route.ts` | 1918 |
...
| `web/src/components/LoginPanel.tsx` | 7576 |
