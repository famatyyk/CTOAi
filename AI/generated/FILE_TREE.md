...
| `.github/workflows/p14-independent-runner-contract.yml` | 5975 |
...
| `AI/generated/ENV_DOCTOR.json` | 7651 |
| `AI/generated/ENV_DOCTOR.md` | 1261 |
| `AI/generated/FILE_TREE.md` | 81551 |
...
| `AI/generated/ROADMAP_STATE.json` | 17135 |
| `AI/generated/ROADMAP_STATE.md` | 2721 |
| `AI/generated/SYMBOL_MAP.md` | 342820 |
...
| `docs/otclient/P14_INDEPENDENT_RUNNER_CONTRACT.md` | 4674 |
...
| `docs/otclient/solteria_safe_release.md` | 2530 |
...
| `mods/ctoa_safe/ctoa_safe_helper.lua` | 173086 |
...
| `scripts/ops/ctoa_full_workspace_audit.py` | 34587 |
...
| `scripts/ops/ctoai_roadmap_state.py` | 39656 |
...
| `scripts/ops/engine_brain_index.py` | 123994 |
| `scripts/ops/engine_brain_pack.py` | 10424 |
...
| `scripts/ops/otclient_helper_module_contract.py` | 27532 |
...
| `scripts/ops/otclient_p14_independent_runner.py` | 31236 |
...
| `scripts/ops/release_evidence_pack.py` | 180297 |
...
| `scripts/windows/solteria_helper_test_env.ps1` | 499356 |
| `scripts/windows/solteria_safe_release.ps1` | 14169 |
| `src/main.py` | 15 |
...
| `tests/test_ctoa_exclusive_project_loader.py` | 38543 |
...
| `tests/test_ctoa_helper_profile_migration.py` | 9349 |
...
| `tests/test_ctoa_helper_vocation_profiles.py` | 7609 |
...
| `tests/test_ctoai_roadmap_state.py` | 13975 |
...
| `tests/test_engine_brain_index.py` | 83765 |
| `tests/test_engine_brain_pack.py` | 4784 |
...
| `tests/test_otclient_helper_module_audit.py` | 21106 |
| `tests/test_otclient_helper_module_contract.py` | 53011 |
...
| `tests/test_otclient_helper_zerobot_shell.py` | 204234 |
| `tests/test_otclient_input_contract_fixtures.py` | 2605 |
| `tests/test_otclient_loader_cross_fork.py` | 11768 |
...
| `tests/test_otclient_p14_independent_runner.py` | 12272 |
...
| `tests/test_p7_roadmap_state_refresh_design.py` | 1275 |
...
| `tests/test_release_evidence_pack.py` | 53477 |
| `tests/test_release_evidence_pack_roadmap_phase_state.py` | 18504 |
...
| `web/src/components/ControlCenterEvidencePanel.tsx` | 81026 |
...
| `web/src/lib/__tests__/controlCenterEvidence.test.ts` | 118118 |
...
| `web/src/lib/controlCenterEvidence.ts` | 182374 |
