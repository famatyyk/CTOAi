...
| `.github/workflows/p14-independent-runner-contract.yml` | 7348 |
...
| `AI/control-central-collection-policy.json` | 182 |
| `AI/control-central-freshness-policy.json` | 312 |
| `AI/ENGINE_BRAIN_STATUS.md` | 149811 |
| `AI/ENGINE_MEMORY.md` | 2971 |
| `AI/FEATURE_ROADMAP.md` | 79625 |
| `AI/generated/DOC_SYNC.json` | 1164 |
| `AI/generated/DOC_SYNC.md` | 681 |
| `AI/generated/ENGINE_BRAIN_PACK.json` | 9611 |
| `AI/generated/ENGINE_BRAIN_PACK.md` | 474885 |
| `AI/generated/ENV_DOCTOR.json` | 7581 |
| `AI/generated/ENV_DOCTOR.md` | 1263 |
| `AI/generated/FILE_TREE.md` | 85421 |
| `AI/generated/manifest.json` | 2062 |
| `AI/generated/OWNERSHIP_MAP.json` | 17957 |
| `AI/generated/OWNERSHIP_MAP.md` | 6981 |
| `AI/generated/P6_CODEX_INTEGRATION_READINESS.json` | 19174 |
| `AI/generated/P6_CODEX_INTEGRATION_READINESS.md` | 11725 |
| `AI/generated/P7_ACTION_READINESS.json` | 5490 |
| `AI/generated/P7_ACTION_READINESS.md` | 1171 |
| `AI/generated/P7_OPERATOR_BRIEF.json` | 22123 |
| `AI/generated/P7_OPERATOR_BRIEF.md` | 2093 |
| `AI/generated/P7_OPERATOR_WORKFLOW.json` | 5398 |
| `AI/generated/P7_OPERATOR_WORKFLOW.md` | 3404 |
| `AI/generated/P7_SAFE_WRITE_TOOL_DESIGN.json` | 2707 |
| `AI/generated/P7_SAFE_WRITE_TOOL_DESIGN.md` | 2024 |
| `AI/generated/ROADMAP_STATE.json` | 17666 |
| `AI/generated/ROADMAP_STATE.md` | 3104 |
| `AI/generated/SYMBOL_MAP.md` | 369500 |
| `AI/KNOWN_BUGS.md` | 1384 |
| `AI/LUA_INDEX.md` | 2874 |
| `AI/OPERATIONS_AUDIT.md` | 5139 |
| `AI/OTCLIENT_INDEX.md` | 4204 |
| `AI/P17_P24_HELPER_EVOLUTION_ROADMAP.json` | 26564 |
| `AI/P17_P24_HELPER_EVOLUTION_ROADMAP.md` | 18696 |
| `AI/P23_2_CONDITION_CORE_DECISION.json` | 2409 |
| `AI/P23_HELPER_SAFE_CONTRACT_INVENTORY.json` | 4234 |
| `AI/P24_REPLAY_CANARY_MATRIX.json` | 9610 |
| `AI/P8_P16_EXECUTION_ROADMAP.md` | 42087 |
...
| `docs/CTOA_CLI.md` | 7883 |
| `docs/CTOAI_COMMAND_RISK_MODEL.md` | 14801 |
...
| `docs/otclient/HELPER_SIMPLIFICATION_AUDIT_2026-07-16.md` | 19778 |
...
| `docs/otclient/P14_INDEPENDENT_RUNNER_CONTRACT.md` | 8332 |
| `docs/otclient/P23_2_CONDITION_CORE_DECISION.md` | 2419 |
| `docs/otclient/P23_HELPER_SAFE_CONTRACT_INVENTORY.md` | 2438 |
| `docs/otclient/P24_REPLAY_CANARY_MATRIX.md` | 2487 |
...
| `docs/otclient/solteria_helper_module_contract.md` | 4592 |
| `docs/otclient/solteria_helper_module_workplan.md` | 12933 |
| `docs/otclient/solteria_helper_next_modules_plan.md` | 20821 |
| `docs/otclient/solteria_helper_sandbox_smoke_queue.md` | 10446 |
| `docs/otclient/solteria_helper_shell_budget_plan.md` | 4230 |
| `docs/otclient/solteria_helper_supplemental_refactor_plan.md` | 27770 |
| `docs/otclient/solteria_helper_test_env.md` | 31237 |
...
| `docs/otclient/solteria_safe_full_audit_v330.md` | 7230 |
| `docs/otclient/solteria_safe_kingsvale_parity.md` | 4280 |
| `docs/otclient/solteria_safe_release.md` | 2679 |
...
| `docs/P7_ROADMAP_STATE_REFRESH_DESIGN.md` | 5333 |
...
| `mods/ctoa_safe/ctoa_safe.otmod` | 309 |
| `mods/ctoa_safe/ctoa_safe_helper.lua` | 216176 |
...
| `schemas/ctoa-p14-acceptance-report.schema.json` | 3645 |
| `schemas/ctoa-p14-acceptance-request.schema.json` | 4429 |
| `schemas/ctoa-p14-acceptance-result.schema.json` | 1848 |
...
| `schemas/ctoa-roadmap-state.schema.json` | 9510 |
...
| `scripts/lua/ctoa_chooser/ctoa_chooser.otmod` | 343 |
| `scripts/lua/ctoa_chooser/ctoa_chooser_loader.lua` | 10558 |
...
| `scripts/lua/otclient/ctoa_helper_diagnostics.lua` | 30864 |
...
| `scripts/lua/otclient/ctoa_helper_hud.lua` | 4071 |
...
| `scripts/lua/otclient/ctoa_helper_module_status.lua` | 5138 |
| `scripts/lua/otclient/ctoa_helper_modules.lua` | 18527 |
| `scripts/lua/otclient/ctoa_helper_operator_summary.lua` | 6395 |
| `scripts/lua/otclient/ctoa_helper_otclient_observation_adapter.lua` | 26413 |
| `scripts/lua/otclient/ctoa_helper_plan_queue.lua` | 2684 |
| `scripts/lua/otclient/ctoa_helper_planner.lua` | 5062 |
| `scripts/lua/otclient/ctoa_helper_profile_persistence.lua` | 16585 |
| `scripts/lua/otclient/ctoa_helper_profile_schema.lua` | 38730 |
...
| `scripts/lua/otclient/ctoa_helper_route.lua` | 13620 |
| `scripts/lua/otclient/ctoa_helper_rule_engine.lua` | 13830 |
...
| `scripts/lua/otclient/ctoa_helper_spell_state_registry.lua` | 12047 |
| `scripts/lua/otclient/ctoa_helper_targeting.lua` | 18186 |
| `scripts/lua/otclient/ctoa_helper_timer_runtime.lua` | 4199 |
| `scripts/lua/otclient/ctoa_helper_ui.lua` | 130526 |
| `scripts/lua/otclient/ctoa_helper_vocation_profiles.lua` | 7826 |
| `scripts/lua/otclient/ctoa_ms_profile.lua` | 2090 |
| `scripts/lua/otclient/ctoa_native_combat.lua` | 18058 |
| `scripts/lua/otclient/ctoa_native_heal.lua` | 9644 |
| `scripts/lua/otclient/ctoa_native_helper.lua` | 173750 |
...
| `scripts/lua/otclient/ctoa_rp_profile.lua` | 1811 |
| `scripts/lua/otclient/README.md` | 26209 |
...
| `scripts/ops/engine_brain_index.py` | 147917 |
| `scripts/ops/engine_brain_pack.py` | 12873 |
...
| `scripts/ops/otclient_conditions_recovery_proof.py` | 11028 |
| `scripts/ops/otclient_conditions_shadow_acceptance.py` | 33279 |
| `scripts/ops/otclient_conditions_shadow_replay.py` | 59396 |
| `scripts/ops/otclient_equipment_candidate_catalog.py` | 15829 |
| `scripts/ops/otclient_equipment_capture_profile_apply.py` | 8553 |
| `scripts/ops/otclient_equipment_capture_profile_change_plan.py` | 35775 |
| `scripts/ops/otclient_equipment_capture_profile_doctor.py` | 11589 |
| `scripts/ops/otclient_equipment_consumer_parity.py` | 25252 |
| `scripts/ops/otclient_equipment_dependency_preflight.py` | 39582 |
| `scripts/ops/otclient_equipment_observation_preview.py` | 14824 |
| `scripts/ops/otclient_equipment_operator_readiness.py` | 22678 |
| `scripts/ops/otclient_equipment_operator_refresh.py` | 19858 |
| `scripts/ops/otclient_equipment_operator_refresh_run.py` | 36463 |
| `scripts/ops/otclient_equipment_shadow_acceptance.py` | 26292 |
| `scripts/ops/otclient_equipment_shadow_replay.py` | 39417 |
| `scripts/ops/otclient_equipment_shadow_snapshot.py` | 23523 |
| `scripts/ops/otclient_external_bot_intake.py` | 14940 |
| `scripts/ops/otclient_fork_capability_detector.py` | 4872 |
| `scripts/ops/otclient_headless_evidence.py` | 36056 |
| `scripts/ops/otclient_headless_status.py` | 31460 |
| `scripts/ops/otclient_heal_friend_candidate_catalog.py` | 7162 |
| `scripts/ops/otclient_heal_friend_observation.py` | 7546 |
| `scripts/ops/otclient_heal_friend_operational_replay.py` | 4637 |
| `scripts/ops/otclient_heal_friend_profile_apply.py` | 5885 |
| `scripts/ops/otclient_heal_friend_profile_change_plan.py` | 7752 |
| `scripts/ops/otclient_heal_friend_shadow_acceptance.py` | 7289 |
| `scripts/ops/otclient_heal_friend_shadow_replay.py` | 47343 |
| `scripts/ops/otclient_helper_module_audit.py` | 35392 |
| `scripts/ops/otclient_helper_module_contract.py` | 28235 |
| `scripts/ops/otclient_helper_next_modules_plan.py` | 33566 |
...
| `scripts/ops/otclient_p12_conditions_execute_once_plan.py` | 7452 |
| `scripts/ops/otclient_p12_conditions_execute_once_receipt.py` | 4539 |
| `scripts/ops/otclient_p12_conditions_execution_approval.py` | 2634 |
| `scripts/ops/otclient_p12_conditions_execution_preflight.py` | 6227 |
| `scripts/ops/otclient_p12_conditions_session_approval.py` | 2945 |
| `scripts/ops/otclient_p12_equipment_execute_once_plan.py` | 11581 |
| `scripts/ops/otclient_p12_equipment_execute_once_receipt.py` | 9553 |
| `scripts/ops/otclient_p12_equipment_execution_approval.py` | 2773 |
| `scripts/ops/otclient_p12_equipment_execution_preflight.py` | 8304 |
| `scripts/ops/otclient_p12_equipment_session_approval.py` | 3071 |
| `scripts/ops/otclient_p12_heal_friend_execute_once_plan.py` | 9137 |
| `scripts/ops/otclient_p12_heal_friend_execute_once_receipt.py` | 7559 |
| `scripts/ops/otclient_p12_heal_friend_execution_approval.py` | 2778 |
| `scripts/ops/otclient_p12_heal_friend_execution_preflight.py` | 9596 |
| `scripts/ops/otclient_p12_heal_friend_no_compatible_vocation_closure.py` | 6677 |
| `scripts/ops/otclient_p12_heal_friend_session_approval.py` | 3184 |
| `scripts/ops/otclient_p14_acceptance_attestation.py` | 19878 |
| `scripts/ops/otclient_p14_independent_runner.py` | 32271 |
| `scripts/ops/otclient_p14_runner_preflight.py` | 38772 |
| `scripts/ops/otclient_recovery_bridge_sandbox_smoke.py` | 5749 |
| `scripts/ops/otclient_runtime_module_gates_sandbox_smoke.py` | 16039 |
...
| `scripts/ops/release_evidence_pack.py` | 201201 |
...
| `scripts/ops/repo_hygiene_audit.py` | 8260 |
| `scripts/ops/repo_hygiene_migration_plan.py` | 7546 |
...
| `scripts/ops/validate_package_boundaries.py` | 5525 |
...
| `scripts/windows/solteria_helper_test_env.ps1` | 502215 |
| `scripts/windows/solteria_safe_release.ps1` | 18263 |
| `src/main.py` | 15 |
| `tests/conftest.py` | 1341 |
| `tests/e2e/__init__.py` | 0 |
| `tests/e2e/test_bot_live.py` | 3380 |
| `tests/e2e/test_browser_smoke.py` | 12736 |
| `tests/fixtures/ctoa_helper_safe_condition_parity_v1.json` | 2263 |
| `tests/fixtures/ctoai-helper-readiness-contract-v1.json` | 14593 |
| `tests/fixtures/lua/ctoa_safe_condition_contract.lua` | 4533 |
...
| `tests/fixtures/otclient_equipment_shadow_replay/positive-p9-receipt.json` | 2176 |
| `tests/fixtures/otclient_equipment_shadow_replay/positive-p9-trace.json` | 1336 |
| `tests/fixtures/otclient_equipment_shadow_replay/positive-snapshot.json` | 1155 |
| `tests/fixtures/otclient_equipment_shadow_replay/scenarios.json` | 5411 |
| `tests/fixtures/otclient_heal_friend_shadow_replay/positive-observation.json` | 1170 |
| `tests/fixtures/otclient_heal_friend_shadow_replay/positive-profile.json` | 892 |
| `tests/fixtures/otclient_heal_friend_shadow_replay/scenarios.json` | 9794 |
...
| `tests/test_control_center_p6_plugin_handoff_smoke.py` | 9401 |
| `tests/test_control_center_p7_cockpit_smoke.py` | 10946 |
| `tests/test_control_center_p7_evidence_review.py` | 6435 |
| `tests/test_control_center_p7_safe_write_dry_run_smoke.py` | 8794 |
| `tests/test_copilot_instructions.py` | 3558 |
| `tests/test_ctoa_env_doctor.py` | 1924 |
| `tests/test_ctoa_exclusive_project_loader.py` | 56748 |
| `tests/test_ctoa_full_workspace_audit.py` | 8747 |
| `tests/test_ctoa_helper_combat_observer.py` | 3463 |
| `tests/test_ctoa_helper_decision_pipeline.py` | 8144 |
| `tests/test_ctoa_helper_diagnostics_log_path.py` | 5925 |
| `tests/test_ctoa_helper_domain_contract.py` | 6569 |
| `tests/test_ctoa_helper_magic_rule_editor.py` | 5880 |
| `tests/test_ctoa_helper_magic_shooter_direction.py` | 1999 |
| `tests/test_ctoa_helper_operator_feedback.py` | 5579 |
| `tests/test_ctoa_helper_otclient_observation_adapter.py` | 16088 |
| `tests/test_ctoa_helper_passive_runtime_probe_summaries.py` | 2602 |
| `tests/test_ctoa_helper_profile_migration.py` | 14076 |
...
| `tests/test_ctoa_helper_rule_engine.py` | 6334 |
| `tests/test_ctoa_helper_runtime_core.py` | 6056 |
| `tests/test_ctoa_helper_runtime_module_gates.py` | 18559 |
| `tests/test_ctoa_helper_safe_contract_parity.py` | 9125 |
| `tests/test_ctoa_helper_smoke_report.py` | 5817 |
| `tests/test_ctoa_helper_spell_state_registry.py` | 7199 |
| `tests/test_ctoa_helper_target_name_policy.py` | 2916 |
| `tests/test_ctoa_helper_target_rule_editor.py` | 12432 |
| `tests/test_ctoa_helper_ui_preview_security.py` | 993 |
| `tests/test_ctoa_helper_vocation_profiles.py` | 11310 |
| `tests/test_ctoa_loader_process_safety.py` | 6925 |
| `tests/test_ctoa_product_bootstrap.py` | 3046 |
| `tests/test_ctoa_public_exposure_audit.py` | 3990 |
| `tests/test_ctoa_root_action_security.py` | 1170 |
| `tests/test_ctoa_runtime_remaining_observers.py` | 5996 |
| `tests/test_ctoa_runtime_telemetry.py` | 6094 |
| `tests/test_ctoa_update_gate.py` | 2922 |
| `tests/test_ctoai_control_central.py` | 62735 |
| `tests/test_ctoai_evidence_io.py` | 1924 |
| `tests/test_ctoai_freshness.py` | 6445 |
| `tests/test_ctoai_helper_readiness.py` | 17382 |
| `tests/test_ctoai_operator_decision.py` | 9963 |
| `tests/test_ctoai_roadmap_state.py` | 17035 |
...
| `tests/test_engine_brain_index.py` | 96248 |
| `tests/test_engine_brain_pack.py` | 6934 |
...
| `tests/test_helper_evolution_roadmap.py` | 11704 |
...
| `tests/test_otclient_conditions_recovery_proof.py` | 5007 |
| `tests/test_otclient_conditions_shadow_acceptance.py` | 22446 |
| `tests/test_otclient_conditions_shadow_consumers.py` | 15537 |
| `tests/test_otclient_conditions_shadow_replay.py` | 31553 |
| `tests/test_otclient_equipment_candidate_catalog.py` | 6882 |
| `tests/test_otclient_equipment_capture_profile_apply.py` | 6284 |
| `tests/test_otclient_equipment_capture_profile_change_plan.py` | 14875 |
| `tests/test_otclient_equipment_capture_profile_doctor.py` | 7759 |
| `tests/test_otclient_equipment_consumer_parity.py` | 12806 |
| `tests/test_otclient_equipment_dependency_preflight.py` | 14276 |
| `tests/test_otclient_equipment_family_registry.py` | 4046 |
| `tests/test_otclient_equipment_observation_preview.py` | 7266 |
| `tests/test_otclient_equipment_operator_readiness.py` | 12725 |
| `tests/test_otclient_equipment_operator_refresh.py` | 16419 |
| `tests/test_otclient_equipment_operator_refresh_run.py` | 17977 |
| `tests/test_otclient_equipment_shadow_acceptance.py` | 12827 |
| `tests/test_otclient_equipment_shadow_replay.py` | 10843 |
| `tests/test_otclient_equipment_shadow_snapshot.py` | 8847 |
| `tests/test_otclient_external_bot_intake.py` | 4551 |
| `tests/test_otclient_fork_capability_detector.py` | 2975 |
| `tests/test_otclient_headless_status.py` | 44502 |
| `tests/test_otclient_heal_friend_candidate_catalog.py` | 4166 |
| `tests/test_otclient_heal_friend_observation.py` | 2591 |
| `tests/test_otclient_heal_friend_operational_replay.py` | 1736 |
| `tests/test_otclient_heal_friend_profile_apply.py` | 3751 |
| `tests/test_otclient_heal_friend_profile_change_plan.py` | 3330 |
| `tests/test_otclient_heal_friend_scan.py` | 3768 |
| `tests/test_otclient_heal_friend_shadow_acceptance.py` | 2200 |
| `tests/test_otclient_heal_friend_shadow_replay.py` | 13641 |
| `tests/test_otclient_helper_diagnostics_ui.py` | 2127 |
| `tests/test_otclient_helper_module_audit.py` | 21555 |
| `tests/test_otclient_helper_module_contract.py` | 51874 |
| `tests/test_otclient_helper_next_modules_plan.py` | 15657 |
| `tests/test_otclient_helper_profile_audit.py` | 3639 |
| `tests/test_otclient_helper_shell_budget_plan.py` | 3079 |
| `tests/test_otclient_helper_zerobot_shell.py` | 207124 |
| `tests/test_otclient_input_contract_fixtures.py` | 2605 |
| `tests/test_otclient_loader_cross_fork.py` | 12170 |
| `tests/test_otclient_p12_conditions_approval_receipt.py` | 4404 |
| `tests/test_otclient_p12_conditions_execute_once.py` | 9285 |
| `tests/test_otclient_p12_conditions_execute_once_plan.py` | 3289 |
| `tests/test_otclient_p12_conditions_execution_preflight.py` | 3496 |
| `tests/test_otclient_p12_equipment_approval_receipt.py` | 11652 |
| `tests/test_otclient_p12_equipment_execute_once.py` | 5645 |
| `tests/test_otclient_p12_equipment_execute_once_plan.py` | 6149 |
| `tests/test_otclient_p12_heal_friend_approval_receipt.py` | 4165 |
| `tests/test_otclient_p12_heal_friend_execute_once.py` | 5883 |
| `tests/test_otclient_p12_heal_friend_execute_once_plan.py` | 5075 |
| `tests/test_otclient_p12_heal_friend_execution_preflight.py` | 5733 |
| `tests/test_otclient_p12_heal_friend_no_compatible_vocation_closure.py` | 4733 |
| `tests/test_otclient_p14_acceptance_attestation.py` | 10872 |
| `tests/test_otclient_p14_independent_runner.py` | 13067 |
| `tests/test_otclient_p14_runner_preflight.py` | 13844 |
| `tests/test_otclient_p8_p9_review_boundaries.py` | 2862 |
| `tests/test_otclient_recovery_bridge_sandbox_smoke.py` | 758 |
| `tests/test_otclient_route_cavebot_probe_contract.py` | 7903 |
| `tests/test_otclient_runtime_module_gates_sandbox_smoke.py` | 2922 |
| `tests/test_otclient_server_profile_schema.py` | 1802 |
| `tests/test_p24_helper_replay_canary_matrix.py` | 3793 |
| `tests/test_p7_roadmap_state_refresh_design.py` | 1280 |
...
| `tests/test_powershell_launcher_security.py` | 15889 |
| `tests/test_process_safety.py` | 1328 |
| `tests/test_project_progress_diagram.py` | 3190 |
| `tests/test_queue_worker_security.py` | 1250 |
| `tests/test_release_evidence_pack.py` | 54719 |
| `tests/test_release_evidence_pack_roadmap_phase_state.py` | 24577 |
| `tests/test_repo_hygiene_audit.py` | 3484 |
| `tests/test_repo_hygiene_distribution.py` | 1371 |
...
| `tests/test_solteria_safe_release.py` | 4223 |
...
| `web/src/app/api/control-center/actions/route.test.ts` | 8384 |
| `web/src/app/api/control-center/actions/route.ts` | 3533 |
...
| `web/src/app/api/control-center/evidence/route.test.ts` | 12944 |
| `web/src/app/api/control-center/evidence/route.ts` | 733 |
| `web/src/app/api/control-center/legacy/route.test.ts` | 1746 |
| `web/src/app/api/control-center/legacy/route.ts` | 703 |
| `web/src/app/api/control-center/operational-routes-auth.test.ts` | 3610 |
| `web/src/app/api/control-center/ops/route.ts` | 1892 |
| `web/src/app/api/control-center/route.test.ts` | 3977 |
| `web/src/app/api/control-center/route.ts` | 2287 |
...
| `web/src/app/control-center/page.tsx` | 1964 |
| `web/src/app/layout.tsx` | 451 |
| `web/src/app/page.tsx` | 6770 |
| `web/src/components/ChatWindow.tsx` | 9132 |
| `web/src/components/CommunityPanel.tsx` | 6607 |
| `web/src/components/ControlCenterActionPanel.tsx` | 12625 |
| `web/src/components/ControlCenterChatPanel.tsx` | 21064 |
| `web/src/components/ControlCenterDataProvider.tsx` | 10244 |
| `web/src/components/ControlCenterDetailPanels.tsx` | 12927 |
| `web/src/components/ControlCenterHelperReadiness.tsx` | 11613 |
| `web/src/components/ControlCenterLiveProbe.tsx` | 3908 |
| `web/src/components/ControlCenterOpsGrid.tsx` | 3872 |
| `web/src/components/ControlCenterShell.tsx` | 17014 |
| `web/src/components/LoginPanel.tsx` | 8459 |
...
| `web/src/lib/__tests__/controlCenterActions.test.ts` | 18391 |
| `web/src/lib/__tests__/controlCenterAuth.test.ts` | 1448 |
| `web/src/lib/__tests__/controlCenterCapabilities.test.ts` | 8331 |
| `web/src/lib/__tests__/controlCenterCapabilityRuntime.test.ts` | 6428 |
| `web/src/lib/__tests__/controlCenterClientError.test.ts` | 2527 |
| `web/src/lib/__tests__/controlCenterDisplayPath.test.ts` | 1875 |
| `web/src/lib/__tests__/controlCenterEngineBrainEvidence.test.ts` | 5040 |
| `web/src/lib/__tests__/controlCenterEvidence.test.ts` | 120121 |
| `web/src/lib/__tests__/controlCenterEvidenceAccess.test.ts` | 1734 |
| `web/src/lib/__tests__/controlCenterEvidenceAdapters.test.ts` | 12154 |
| `web/src/lib/__tests__/controlCenterEvidenceIo.test.ts` | 2540 |
| `web/src/lib/__tests__/controlCenterEvidenceSlices.test.ts` | 3457 |
| `web/src/lib/__tests__/controlCenterHelperReadiness.test.ts` | 9749 |
| `web/src/lib/__tests__/controlCenterMarkdownReport.test.ts` | 3850 |
| `web/src/lib/__tests__/controlCenterOperatingState.test.ts` | 1512 |
| `web/src/lib/__tests__/controlCenterOperatorDecision.test.ts` | 3966 |
| `web/src/lib/__tests__/controlCenterOps.test.ts` | 23914 |
| `web/src/lib/__tests__/controlCenterSnapshot.test.ts` | 719 |
| `web/src/lib/__tests__/rateLimit.test.ts` | 2240 |
| `web/src/lib/__tests__/requestOriginGuard.test.ts` | 3493 |
...
| `web/src/lib/controlCenterActions.ts` | 24925 |
| `web/src/lib/controlCenterAuth.ts` | 1559 |
| `web/src/lib/controlCenterCapabilities.ts` | 23916 |
| `web/src/lib/controlCenterCapabilityRuntime.ts` | 1884 |
| `web/src/lib/controlCenterDisplayPath.ts` | 1492 |
| `web/src/lib/controlCenterEngineBrainEvidence.ts` | 21583 |
| `web/src/lib/controlCenterEvidence.ts` | 161871 |
| `web/src/lib/controlCenterEvidenceAccess.ts` | 1708 |
| `web/src/lib/controlCenterEvidenceAdapters.ts` | 24124 |
| `web/src/lib/controlCenterEvidenceConfig.ts` | 8155 |
| `web/src/lib/controlCenterEvidenceIo.ts` | 5767 |
| `web/src/lib/controlCenterHelperReadiness.ts` | 29262 |
| `web/src/lib/controlCenterMarkdownReport.ts` | 1446 |
| `web/src/lib/controlCenterMarkdownReportFile.ts` | 1546 |
| `web/src/lib/controlCenterOperatingState.ts` | 1789 |
| `web/src/lib/controlCenterOperatorDecision.ts` | 10335 |
| `web/src/lib/controlCenterOps.ts` | 13808 |
| `web/src/lib/controlCenterPolicy.ts` | 1206 |
| `web/src/lib/controlCenterRedaction.ts` | 1247 |
| `web/src/lib/controlCenterSnapshot.ts` | 1049 |
| `web/src/lib/fetchWithTimeout.ts` | 671 |
| `web/src/lib/rateLimit.ts` | 1525 |
| `web/src/lib/requestOriginGuard.ts` | 1904 |
