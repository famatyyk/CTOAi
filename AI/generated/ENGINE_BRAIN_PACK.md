...
Generated at: `2026-07-11T03:57:09+00:00`
...
{
  "schema_version": 1,
  "generated_at": "2026-07-11T03:56:45+00:00",
...
Generated at: `2026-07-11T03:57:01+00:00`
Overall status: `warn`

| Check | Status | Key evidence |
|---|---|---|
| `git` | `ok` | branch=codex/control-center-guarded-actions; dirty=274; path=C:\Program Files\Git\cmd\git.EXE |
...
| `.git` | Local/uncategorized | `manual review` | 324 | git_internal:324 |
| `.gitattributes` | Local/uncategorized | `manual review` | 1 | tracked_source:1 |
| `.github` | Local/uncategorized | `manual review` | 40 | tracked_source:40 |
...
| `.ruff_cache` | Local/uncategorized | `manual review` | 14 | untracked_local:14 |
...
| `AI` | Engine Brain | `brain refresh; brain pack` | 45 | local_secret_or_sensitive:2, tracked_source:2, untracked_source_candidate:41 |
...
| `api` | API runtime | `pytest tests/ --ignore=tests/e2e` | 9 | tracked_source:2, untracked_source_candidate:7 |
| `bot` | Bot runtime | `pytest tests/ --ignore=tests/e2e` | 144 | tracked_source:42, untracked_source_candidate:102 |
...
| `docs` | Documentation | `doc sync guard` | 314 | tracked_source:304, untracked_source_candidate:10 |
...
| `metrics` | Local/uncategorized | `manual review` | 2 | runtime_or_local_state:2 |
...
| `runner` | Runner runtime | `pytest tests/ --ignore=tests/e2e` | 154 | tracked_source:52, untracked_source_candidate:102 |
| `runtime` | Local/uncategorized | `manual review` | 1922 | runtime_or_local_state:1922 |
| `schemas` | Contracts | `schema consumers and pytest` | 6 | tracked_source:6 |
| `scoring` | Local/uncategorized | `manual review` | 6 | tracked_source:4, untracked_source_candidate:2 |
| `scripts` | Operator automation | `pytest targeted script tests` | 429 | tracked_source:239, untracked_source_candidate:190 |
| `tests` | Regression suite | `pytest tests/ --ignore=tests/e2e` | 494 | local_secret_or_sensitive:4, tracked_source:115, untracked_source_candidate:375 |
| `tools` | Local/uncategorized | `manual review` | 76 | tracked_source:76 |
...
| `web` | Control Center | `cd web; npm run lint; npm test` | 32304 | local_secret_or_sensitive:2, tracked_source:64, untracked_source_candidate:5453, vendor_or_cache:26785 |
...
Generated at: `2026-07-11T03:56:45+00:00`
Status: `passed`
Sensitive/local env path count in audit: `11`
...
| `docs/audits/CTOAI_FULL_WORKSPACE_AUDIT_2026-07-06.md` | 7049 |
...
| `docs/roadmaps/CTOAI_THREE_DEVELOPMENT_PLANS_2026-07-06.md` | 6811 |
...
| `schemas/ctoa-command-dictionary.json` | 3172 |
...
| `scripts/ops/bridge_replacement_readiness.py` | 3493 |
...
| `scripts/ops/kv_attach_first_hit.py` | 2332 |
...
| `scripts/ops/repo_hygiene_audit.py` | 8321 |
| `scripts/ops/repo_hygiene_migration_plan.py` | 7540 |
| `scripts/ops/rosetta_bundle.py` | 7967 |
...
| `scripts/ops/run-x64dbg-enc3-dynamic-pass.py` | 10328 |
| `scripts/ops/run_validator_with_preflight.py` | 1437 |
| `scripts/ops/runtime_path_guard.py` | 2689 |
| `scripts/ops/runtime_smoke_e2e_8001.py` | 2023 |
| `scripts/ops/smoke_must_pass.py` | 2630 |
...
| `scripts/ops/sprint028_validate.py` | 11751 |
