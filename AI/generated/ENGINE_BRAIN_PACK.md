...
- Keep P10 blocked until ctoa.ps1 otp9 produces a reviewed real P9 trace under accepted P8 and Recovery proofs and the separate data-only acceptance boundary validates it.
