-- Default Master Sorcerer profile. Runtime remains safe-boot disabled.
return {
    schema_version = "ctoa-helper-profile-v1", vocation = "ms", name = "CTOAI MS profile",
    ...
    tools = {
        ...
        rotation_spells={
            {words="exevo gran mas vis",min_nearby=3,cooldown_ms=8000,scan_range=3},
            {words="exevo vis hur",min_nearby=2,cooldown_ms=4000,scan_range=3},
            {words="exori gran vis",min_nearby=1,max_nearby=2,cooldown_ms=2000,scan_range=3},
        },
