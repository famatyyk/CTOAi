...
return {
    ...
    heal_friend = {enabled=false, runtime_enabled=false, observe_party=true, sio_spell="exura sio", hp_threshold=70, friend_whitelist={}, friend_target_id=0, priority="single_exact_target", require_whitelist=true},
