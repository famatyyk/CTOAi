...
function CavebotRuntime.probeSnapshot(snapshot)
    ...
    return {
        ...
        game_walk = tostring(data.game_walk or "false"),
        game_auto = tostring(data.game_auto or "false"),
        game_force = tostring(data.game_force or "false"),
        player_walk = tostring(data.player_walk or "false"),
        player_stop = tostring(data.player_stop or "false"),
        player_can = tostring(data.player_can or "n/a"),
...
function CavebotRuntime.probeReport(snapshot)
    ...
    return {
        snapshot = data,
        text = CavebotRuntime.probeSummary(data),
    }
end
