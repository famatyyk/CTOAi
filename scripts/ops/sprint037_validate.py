...
REQUIRED_FILES = ['workflows/backlog-sprint-037.yaml', 'workflows/sprint-037-delivery-flow.yaml', 'scripts/ops/sprint037_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
