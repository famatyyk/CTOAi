...
REQUIRED_FILES = ['workflows/backlog-sprint-038.yaml', 'workflows/sprint-038-delivery-flow.yaml', 'scripts/ops/sprint038_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
