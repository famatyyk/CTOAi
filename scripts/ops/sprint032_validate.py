...
REQUIRED_FILES = ['workflows/backlog-sprint-032.yaml', 'workflows/sprint-032-delivery-flow.yaml', 'scripts/ops/sprint032_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
