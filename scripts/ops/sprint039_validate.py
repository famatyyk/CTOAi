...
REQUIRED_FILES = ['workflows/backlog-sprint-039.yaml', 'workflows/sprint-039-delivery-flow.yaml', 'scripts/ops/sprint039_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
