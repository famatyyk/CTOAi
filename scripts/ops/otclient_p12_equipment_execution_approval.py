#!/usr/bin/env python3
"""Add the separate P12 Equipment execution approval; never execute the action."""
...
if __package__:
    ...
    from . import otclient_p12_equipment_session_approval as sessions
else:  # pragma: no cover
    import otclient_p12_equipment_execute_once_plan as plans
    import otclient_p12_equipment_session_approval as sessions
