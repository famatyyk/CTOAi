...
REQUIRED_FILES = ['workflows/backlog-sprint-035.yaml', 'workflows/sprint-035-delivery-flow.yaml', 'scripts/ops/sprint035_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
