...
REQUIRED_FILES = ['workflows/backlog-sprint-031.yaml', 'workflows/sprint-031-delivery-flow.yaml', 'scripts/ops/sprint031_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
