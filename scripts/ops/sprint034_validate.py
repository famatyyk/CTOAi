...
REQUIRED_FILES = ['workflows/backlog-sprint-034.yaml', 'workflows/sprint-034-delivery-flow.yaml', 'scripts/ops/sprint034_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
