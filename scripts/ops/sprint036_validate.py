...
REQUIRED_FILES = ['workflows/backlog-sprint-036.yaml', 'workflows/sprint-036-delivery-flow.yaml', 'scripts/ops/sprint036_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
