#!/usr/bin/env python3
"""Persist a hash-bound P12 Equipment sandbox-session approval; never execute."""
...
OUTPUT = plans.DEV / "p12_equipment_session_approval.json"
SCHEMA = "ctoa.p12-equipment-session-approval.v1"
...
def build_approval(
    ...
    return {
        ...
        "approval_id": f"p12-equipment-session-{uuid.uuid4().hex[:16]}",
