...
REQUIRED_FILES = ['workflows/backlog-sprint-033.yaml', 'workflows/sprint-033-delivery-flow.yaml', 'scripts/ops/sprint033_validate.py', '.vscode/tasks.json', '.github/workflows/ctoa-pipeline.yml']
